...
public class DaoUtil
{
	...
	public static boolean delete(String tableName,String id,JdbcTemplate jdbcTemplate) throws LittleCatException
	{
	...
	public static boolean delete(String tableName,List<String> ids,JdbcTemplate jdbcTemplate) throws LittleCatException
	{
